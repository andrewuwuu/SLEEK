...
class FoodPagerAdapter(fa: FragmentActivity) : FragmentStateAdapter(fa) {
    private val fragments = mutableListOf<FoodCategoryFragment>()

    init {
        // Inisialisasi fragment dengan tag yang sesuai
        fragments.add(FoodCategoryFragment.newInstance("Sarapan"))
        fragments.add(FoodCategoryFragment.newInstance("Makan Siang"))
        fragments.add(FoodCategoryFragment.newInstance("Makan Malam"))
    }
